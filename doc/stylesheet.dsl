...
;;    INLINES
;;=================
(define ($colour-green$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "GREEN"))
        sosofo))
(define ($colour-aqua$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "AQUA"))
        sosofo))
(define ($colour-black$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "BLACK"))
        sosofo))
(define ($colour-blue$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "BLUE"))
        sosofo))
(define ($colour-fuchsia$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "FUCHSIA"))
        sosofo))
(define ($colour-gray$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "GRAY"))
        sosofo))
(define ($colour-lime$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "LIME"))
        sosofo))
(define ($colour-maroon$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "MAROON"))
        sosofo))
(define ($colour-navy$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "NAVY"))
        sosofo))
(define ($colour-olive$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "OLIVE"))
        sosofo))
(define ($colour-purple$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "PURPLE"))
        sosofo))
(define ($colour-red$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "RED"))
        sosofo))
(define ($colour-silver$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "SILVER"))
        sosofo))
(define ($colour-teal$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "TEAL"))
        sosofo))
(define ($colour-white$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
        attributes: '(("COLOR" "WHITE"))
        sosofo))
(define ($colour-yellow$ #!optional (sosofo (process-children)))
  (make element gi: "FONT"
...
(element symbol ($charseq$))
(element emphasis
    (cond  ((equal? (attribute-string (normalize "role")) "green")   ($colour-green$))
           ((equal? (attribute-string (normalize "role")) "aqua")    ($colour-aqua$))
           ((equal? (attribute-string (normalize "role")) "black")   ($colour-black$))
           ((equal? (attribute-string (normalize "role")) "blue")    ($colour-blue$))
           ((equal? (attribute-string (normalize "role")) "fuchsia") ($colour-fuchsia$))
           ((equal? (attribute-string (normalize "role")) "gray")    ($colour-gray$))
           ((equal? (attribute-string (normalize "role")) "lime")    ($colour-lime$))
           ((equal? (attribute-string (normalize "role")) "maroon")  ($colour-maroon$))
           ((equal? (attribute-string (normalize "role")) "navy")    ($colour-navy$))
           ((equal? (attribute-string (normalize "role")) "olive")   ($colour-olive$))
           ((equal? (attribute-string (normalize "role")) "purple")  ($colour-purple$))
           ((equal? (attribute-string (normalize "role")) "red")     ($colour-red$))
           ((equal? (attribute-string (normalize "role")) "silver")  ($colour-silver$))
           ((equal? (attribute-string (normalize "role")) "teal")    ($colour-teal$))
           ((equal? (attribute-string (normalize "role")) "white")   ($colour-white$))
           ((equal? (attribute-string (normalize "role")) "yellow")  ($colour-yellow$))
           (else                                                     ($italic-seq$))
    )
)
;;Show comment element?
