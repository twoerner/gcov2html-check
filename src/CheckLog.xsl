...
<xsl:template match="check:testsuites">
 ...
 <h3>Unit Test Coverage Statistics</h3>
 <ul>
  <li>lines executed: <xsl:apply-templates select="check:coverage"/></li>
  <li>branches executed: <xsl:apply-templates select="check:branches"/></li>
  <li>branches taken at least once: <xsl:apply-templates select="check:taken"/></li>
  <li>calls executed: <xsl:apply-templates select="check:calls"/></li>
 </ul>
 <hr></hr>
</xsl:template>
